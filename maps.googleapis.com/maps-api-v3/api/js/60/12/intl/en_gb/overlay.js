google.maps.__gjsload__('overlay', function(_) {
    var hCa = function() {},
        ...
        qCa = function(a) {
            if (a) {
                var b = a.getMap();
                if (mCa(a) !== b && b && b instanceof _.Ck) {
                    const c = b.__gm;
                    c.overlayLayer ? a.__gmop = new nCa(b, a, c.overlayLayer) : c.Fg.then(({
                        ah: d
                    }) => {
                        const e = new oCa(b, d);
                        d.Li(e);
    ...
    var nCa = class {
        ...
        oCa = class {
            ...
            Nh(a, b, c, d, e, f, g, h) {
                ...
                for (const n of this.Fg) rCa(n, l), n.draw()
            }
            so(a) {
                this.Fg.push(a);
                this.Eg &&
    ...
    _.Ki("overlay", {
        iD: function(a) {
            if (a) {
                ...
                pCa(a);
                var b = a.getMap();
                b && (b instanceof _.Ck ? qCa(a) : a && (b = a.getMap(), (mE(a).Jg || null) !== b && (b && kCa(a, b), mE(a).Jg = b)))
            }
        },
